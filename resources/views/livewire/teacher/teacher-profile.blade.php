    ...
    <div class="bg-white shadow-lg rounded-2xl overflow-hidden">
        ...
        <div class="p-6">
            <div class="flex flex-col sm:flex-row gap-4">
                {{-- Edit Button --}}
                <a href="{{ route('hr.staff.edit', $teacher->staff) }}" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-medium transition">
