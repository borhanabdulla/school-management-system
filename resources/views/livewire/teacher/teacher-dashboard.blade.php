                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <a href="{{ route('students.index') }}" class="flex flex-col items-center justify-center p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50 hover:bg-purple-50 dark:hover:bg-purple-900/30 transition-all group text-center">
                                ...
                                <span class="text-xs font-medium text-gray-700 dark:text-gray-300">الطلاب</span>
                            </a>
                        </div>
                    </div>
                </div>
