...
<div class="mb-6">
    <div class="rounded-2xl border border-gray-200 bg-white p-1.5 shadow-sm dark:border-slate-700 dark:bg-slate-800">
        <nav class="flex space-x-1 rtl:space-x-reverse overflow-x-auto no-scrollbar">
            ...
            <button wire:click="$set('activeTab', 'profile')"
                class="flex-1 whitespace-nowrap rounded-xl px-4 py-2.5 text-sm font-semibold transition-all duration-200 {{ $activeTab === 'profile' 
                    ...
                    : 'text-gray-500 hover:bg-gray-50 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-slate-700 dark:hover:text-gray-200' }}">
                <div class="flex items-center justify-center gap-2">
                    <svg class="h-4 w-4 {{ $activeTab === 'profile' ? 'text-purple-600 dark:text-purple-400' : 'text-gray-400 dark:text-slate-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button wire:click="$set('activeTab', 'academic')"
                class="flex-1 whitespace-nowrap rounded-xl px-4 py-2.5 text-sm font-semibold transition-all duration-200 {{ $activeTab === 'academic' 
                    ...
                    : 'text-gray-500 hover:bg-gray-50 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-slate-700 dark:hover:text-gray-200' }}">
                <div class="flex items-center justify-center gap-2">
                    <svg class="h-4 w-4 {{ $activeTab === 'academic' ? 'text-purple-600 dark:text-purple-400' : 'text-gray-400 dark:text-slate-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button wire:click="$set('activeTab', 'guardians')"
                class="flex-1 whitespace-nowrap rounded-xl px-4 py-2.5 text-sm font-semibold transition-all duration-200 {{ $activeTab === 'guardians' 
                    ...
                    : 'text-gray-500 hover:bg-gray-50 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-slate-700 dark:hover:text-gray-200' }}">
                <div class="flex items-center justify-center gap-2">
                    <svg class="h-4 w-4 {{ $activeTab === 'guardians' ? 'text-purple-600 dark:text-purple-400' : 'text-gray-400 dark:text-slate-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button wire:click="$set('activeTab', 'grades')"
                class="flex-1 whitespace-nowrap rounded-xl px-4 py-2.5 text-sm font-semibold transition-all duration-200 {{ $activeTab === 'grades' 
                    ...
                    : 'text-gray-500 hover:bg-gray-50 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-slate-700 dark:hover:text-gray-200' }}">
                <div class="flex items-center justify-center gap-2">
                    <svg class="h-4 w-4 {{ $activeTab === 'grades' ? 'text-purple-600 dark:text-purple-400' : 'text-gray-400 dark:text-slate-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
