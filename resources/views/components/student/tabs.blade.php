    ...
    <div class="border-b border-border">
        <nav class="-mb-px flex space-x-8">
            <button wire:click="$set('activeTab', 'profile')"
                :class="activeTab === 'profile' ? 'border-primary text-primary' :
            ...
            <button wire:click="$set('activeTab', 'guardians')"
                :class="activeTab === 'guardians' ? 'border-primary text-primary' :
                    'border-transparent text-muted-foreground hover:text-foreground hover:border-border'"
                class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors">
                <div class="flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button wire:click="$set('activeTab', 'grades')"
                :class="activeTab === 'grades' ? 'border-primary text-primary' :
                    'border-transparent text-muted-foreground hover:text-foreground hover:border-border'"
                class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors">
                <div class="flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
