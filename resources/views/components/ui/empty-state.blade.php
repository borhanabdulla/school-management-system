...
<div {{ $attributes->merge(['class' => 'bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-dashed border-gray-200 dark:border-slate-700 p-12 text-center']) }}>
    ...
    <p class="text-gray-500 dark:text-gray-400 max-w-sm mx-auto">{{ $description }}</p>
</div>
