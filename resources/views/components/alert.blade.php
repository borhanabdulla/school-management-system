...
@php
    ...
    $classes = 'border rounded-md p-4 ' . ($types[$type] ?? $types['info']);
@endphp
        ...
        @if($dismissible)
            <div class="ml-auto pl-3">
                <div class="-mx-1.5 -my-1.5">
                    <button @click="show = false" type="button" class="inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 {{ str_replace('bg-', 'focus:ring-', $types[$type]) }} {{ str_replace('text-', 'text-', $types[$type]) }} hover:bg-opacity-20">
